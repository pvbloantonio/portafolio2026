    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-gray-900 rounded-xl border border-white/10 p-8">
          ...
          <p className="text-gray-400 text-sm mb-6">Inicia sesión para ver los mensajes de contacto</p>
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-7xl mx-auto p-4">
        ...
        {!loading && messages.length === 0 && (
          <div className="text-center py-12 text-gray-400">Sin mensajes aún.</div>
        )}
          ...
          {messages.map((msg) => (
            <div key={msg.id} className="bg-gray-900 rounded-xl border border-white/10 p-6">
              ...
              <div className="flex items-center gap-4 text-xs text-gray-500">
                {msg.time_on_page && <span>Tiempo en página: {msg.time_on_page}s</span>}
