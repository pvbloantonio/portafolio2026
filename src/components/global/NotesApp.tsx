...
const NotesApp = ({ isOpen, onClose, section }: NotesAppProps) => {
    ...
    const renderEducation = () => (
        <div className="space-y-6">
            {renderBackButton()}
            <h2 className="text-2xl font-bold text-gray-200 mb-6">Educación</h2>
    ...
    const renderExperience = () => (
        <div className="space-y-6">
            {renderBackButton()}
            <h2 className="text-2xl font-bold text-gray-200 mb-6">Experiencia Profesional</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    const renderCourses = () => (
        <div className="space-y-6">
            {renderBackButton()}
            <h2 className="text-2xl font-bold text-gray-200 mb-6">Cursos y Certificados</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    const renderSkills = () => {
        ...
        return (
            <div className="space-y-6">
                ...
                <p className="text-sm text-gray-400 mb-4">La intensidad muestra con qué frecuencia aparece una habilidad en mis proyectos.</p>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                        {skills.map((skill, index) => (
                            <button
                                ...
                                title={`Usado en ${freq[skill] || 0} proyecto(s)`}
    ...
    const renderExtraCurricularRoles = () => (
        <div className="space-y-6">
            {renderBackButton()}
            <h2 className="text-2xl font-bold text-gray-200 mb-6">Roles Extracurriculares</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    const renderExtraCurricularActivities = () => (
        <div className="space-y-6">
            {renderBackButton()}
            <h2 className="text-2xl font-bold text-gray-200 mb-6">Actividades Extracurriculares</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    const renderCompetitions = () => (
        <div className="space-y-6">
            {renderBackButton()}
            <h2 className="text-2xl font-bold text-gray-200 mb-6">Logros</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {competitions.map((item, index) => {
                    ...
                    return (
                        <div key={itemId} className="bg-gray-800/50 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                            ...
                            <div className="text-gray-400 mb-3">Logro: {item.achievement} ({item.year})</div>
                            {item.images && item.images.length > 0 && renderImageCarousel(itemId, item.images)}
                        </div>
                    );
                })}
    ...
    const renderMenu = () => (
        <div>
            <h2 className="text-2xl font-bold text-gray-200 mb-6">Mis Notas</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-xl font-semibold text-gray-200">Logros</h3>
                    </div>
                    <p className="text-gray-400">Ver mis logros y certificaciones</p>
                </button>
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-xl font-semibold text-gray-200">Educación</h3>
                    </div>
                    <p className="text-gray-400">Ver mi formación académica</p>
                </button>
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-xl font-semibold text-gray-200">Experiencia Profesional</h3>
                    </div>
                    <p className="text-gray-400">Ver mi experiencia laboral</p>
                </button>
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-xl font-semibold text-gray-200">Roles Extracurriculares</h3>
                    </div>
                    <p className="text-gray-400">Mi participación en actividades y roles</p>
                </button>
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-xl font-semibold text-gray-200">Actividades Extracurriculares</h3>
                    </div>
                    <p className="text-gray-400">Mi participación en eventos y actividades</p>
                </button>
                {/* Courses */}
                <button
                    type="button"
                ...
                >
                    ...
                    <p className="text-gray-400">Cursos y certificados completados</p>
                </button>
                ...
                >
                    ...
                    <p className="text-gray-400">Ver mis habilidades técnicas</p>
                </button>
            </div>
        </div>
    );
    ...
    const getWindowTitle = () => {
        switch (activeSection) {
            ...
            case 'roles': return 'Roles Extracurriculares';
            case 'activities': return 'Actividades';
            case 'competitions': return 'Logros';
