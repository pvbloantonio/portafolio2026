    ...
    <>
      ...
      <div className="flex flex-col flex-grow min-h-0 h-full">
        <div className="overflow-y-auto flex-grow min-h-0 p-4 md:p-6">
          {!showStructure ? (
            <>
              <h2 className="text-2xl font-bold mb-4 text-gray-200">Mis Proyectos</h2>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-800/50 rounded-lg p-4">
                  <h3 className="text-xl font-semibold mb-4 text-gray-200">Estructura del Proyecto</h3>
                ...
                {selectedProject && selectedProject.images && selectedProject.images.length > 0 && (
                  <div className="bg-gray-800/50 rounded-lg p-4">
                    <h3 className="text-xl font-semibold mb-4 text-gray-200">Capturas</h3>
