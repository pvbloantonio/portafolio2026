...
const handleSpotifyClick = () => {
  ...
  const icons = [
    { id: 'github', label: 'Mis Proyectos', onClick: onGitHubClick, icon: BsGithub, color: 'from-black to-black/60', active: activeApps.github },
    { id: 'notes', label: 'Notas del CV', onClick: onNotesClick, icon: BsStickyFill, color: 'from-yellow-600 to-yellow-400', active: activeApps.notes },
    { id: 'resume', label: 'Ver CV', onClick: handleResumeClick, icon: BsFilePdf, color: 'from-red-600 to-red-400', active: activeApps.resume },
    ...(userConfig.contact.calendly ? [{ id: 'calendar', label: 'Agendar llamada', onClick: handleCalendarClick, icon: BsCalendar, color: 'from-blue-600 to-blue-400', active: false }] : []),
    { id: 'spotify', label: 'Lista de Spotify', onClick: handleSpotifyClick, icon: BsSpotify, color: 'from-green-600 to-green-400', active: activeApps.spotify },
    { id: 'email', label: 'Contacto', onClick: onContactClick, icon: IoIosMail, color: 'from-blue-600 to-blue-400', active: false },
    { id: 'links', label: 'Links de Contacto', onClick: handleLinksClick, icon: FaLink, color: 'from-purple-600 to-purple-400', active: false },
